# -*- coding: utf-8 -*-
# Bac SIMPLIFIE (grilles circulaires, fn bas) -> v4_base.step :
...
stl  = os.path.join(HERE, "v4_base_step.stl")
step = os.path.join(HERE, "v4_base.step")
...
feat = doc.addObject("Part::Feature", "v4_base"); feat.Shape = best
doc.recompute(); Part.export([feat], step)
print("STEP -> v4_base.step  valid=%s closed=%s faces=%d  (%d Ko)"
