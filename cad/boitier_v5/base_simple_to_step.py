# -*- coding: utf-8 -*-
# Bac SIMPLIFIE (grilles circulaires, fn bas) -> v5_base.step :
...
stl  = os.path.join(HERE, "v5_base_step.stl")
step = os.path.join(HERE, "v5_base.step")
...
feat = doc.addObject("Part::Feature", "v5_base"); feat.Shape = best
doc.recompute(); Part.export([feat], step)
print("STEP -> v5_base.step  valid=%s closed=%s faces=%d  (%d Ko)"
