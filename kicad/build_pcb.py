...
COMPONENTS = [
    # --- ESP32-S3 DevKitC-1 : plugs into 2x11 female header strip ---
    ("U1", "Connector_PinHeader_2.54mm", "PinHeader_2x11_P2.54mm_Vertical",
     55, 50, 0, "ESP32-S3-DevKitC-1", {
        "1":"BTN_CENTER","2":"MUTE_SW","3":"MIC_LRCLK","4":"MIC_BCLK","5":"MIC_DIN",
        "6":"ENC_A","7":"JACK_DET","8":"ENC_B","9":"DAC_LRCK","10":"DAC_BCK",
        "11":"DAC_DIN","12":"LED_DIN_RAW","13":"LED_PWR_EN","14":"AMP_EN",
        "15":"+3V3","16":"+5V","17":"GND",
     }),
    ...
    # --- Discrete passives ---
    ("R1", "Resistor_SMD", "R_0603_1608Metric", 38, 46, 0, "10k",
        {"1":"BTN_CENTER","2":"+3V3"}),
    ("R2", "Resistor_SMD", "R_0603_1608Metric", 110, 30, 0, "330",
        {"1":"LED_DIN_RAW","2":"LED_DIN"}),
    ("C1", "Capacitor_SMD", "C_0603_1608Metric", 30, 26, 0, "10uF",
        {"1":"+5V","2":"GND"}),
    ("C2", "Capacitor_SMD", "C_0603_1608Metric", 35, 26, 0, "100nF",
        {"1":"+5V","2":"GND"}),
    ("C3", "Capacitor_SMD", "C_0603_1608Metric", 40, 26, 0, "10uF",
        {"1":"+3V3","2":"GND"}),
    ("C4", "Capacitor_SMD", "C_0603_1608Metric", 45, 26, 0, "10uF",
        {"1":"+3V3","2":"GND"}),
    ("C5", "Capacitor_SMD", "CP_Elec_5x5.3", 80, 88, 0, "100uF",
        {"1":"+5V","2":"GND"}),
    ("C6", "Capacitor_SMD", "CP_Elec_5x5.3", 95, 16, 0, "470uF",
        {"1":"+5V_LED","2":"GND"}),
    # --- P-MOSFET AO3401 SOT-23 (1=Gate 2=Source 3=Drain) ---
    ("Q1", "Package_TO_SOT_SMD", "SOT-23", 120, 48, 0, "AO3401",
        {"1":"LED_PWR_EN","2":"+5V","3":"+5V_LED"}),
    # --- Ferrite bead ---
    ("F1", "Inductor_SMD", "L_0805_2012Metric", 70, 16, 0, "Ferrite 600R",
        {"1":"+5V","2":"+5V_LED"}),
    # --- Speaker connectors ---
    ("HP1", "Connector_PinHeader_2.54mm", "PinHeader_1x02_P2.54mm_Vertical",
     118, 66, 0, "HP-Left", {"1":"SPK_L","2":"GND"}),
    ("HP2", "Connector_PinHeader_2.54mm", "PinHeader_1x02_P2.54mm_Vertical",
     118, 76, 0, "HP-Right", {"1":"SPK_R","2":"GND"}),
]
